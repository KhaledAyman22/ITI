...
public:
    MyRectangle(int _color){
        color = _color;
    }

    MyRectangle(int _x1, int _y1, int _x2, int _y2, int _color): upper(_x1, _y1), lower(_x2, _y2)
    {
        color = _color;
    }
...
public:
    ...
    MyCircle(int _x, int _y, int _radius, int _color) : center(_x, _y)
    {
        color = _color;
        radius = _radius;
    }
