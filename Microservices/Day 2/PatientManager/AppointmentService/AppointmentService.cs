            ...
            return new ServiceInstanceListener[]
            {
                new ServiceInstanceListener(serviceContext =>
                    new KestrelCommunicationListener(serviceContext, "ServiceEndpoint", (url, listener) =>
                    {
                        ...
                        {
                            var client = new ServiceBusClient("Endpoint=sb://iti43microservicestask02.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=3YMogT7898kSP23xKVp3vnA8tukhoxn2s+ASbEuFKTM=");
