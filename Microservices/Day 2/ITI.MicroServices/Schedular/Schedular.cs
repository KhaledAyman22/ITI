...
namespace Schedular
{
    ...
    /// </summary>
    internal sealed class Schedular : StatelessService
    {
        public Schedular(StatelessServiceContext context)
            : base(context)
        { }
            ...
            return new ServiceInstanceListener[]
            {
                new ServiceInstanceListener(serviceContext =>
                    new KestrelCommunicationListener(serviceContext, "ServiceEndpoint", (url, listener) =>
                    {
                        ...
                        {
                            var client = new ServiceBusClient("Endpoint=sb://itidemo.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=ZWM2IYWJzoxV+G4LxYc1ykYOQj9BrAUhy+ASbEWVUgg=");
                            var sender = client.CreateSender("notificationqueue");
